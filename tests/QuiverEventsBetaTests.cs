...
{
    [TestFixture]
    public class QuiverEventsBetaTests
    {
        [Test]
        ...
        private BaseData CreateNewInstance()
        {
            return new QuiverEventsBeta
            {
                ...
                Date = DateTime.Today,
                EventName = "PresidentialElection2020",
                FirstEventName = "TrumpVictory",
                SecondEventName = "BidenVictory",
                FirstEventBeta = 1m,
                SecondEventBeta = 1m,
                FirstEventOdds = 0.5m,
                SecondEventOdds = 0.5m
            };
        }
    }
}
